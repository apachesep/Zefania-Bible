...
class JDomHtmlGrid extends JDomHtml
{
	...
	function __construct($args)
	{
		...
		$this->arg('dataKey'	, 2, $args);
		$this->arg('dataObject'	, 3, $args);
		$key = $this->dataKey;
		$this->arg('dataValue'	, 4, $args, (($this->dataObject && $key)?(isset($this->dataObject->$key)?$this->dataObject->$key:null):null));
		$this->arg('num'		, 5, $args);
