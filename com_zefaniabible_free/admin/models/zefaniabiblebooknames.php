...
/**
 * Zefaniabible Component Zefaniabiblebooknames Model
 *
 * @package		Joomla
 * @subpackage	Zefaniabible
 *
 */
class ZefaniabibleModelZefaniabiblebooknames extends ZefaniabibleModelList
{
	var $_name_sing = 'zefaniabiblebooksitem';
	...
	function __construct($config = array())
	{
		...
		if (empty($config['filter_fields'])) {
			$config['filter_fields'] = array(
				'bible_book_name', 'a.bible_book_name',
	...
	function _buildQueryWhere($where = array())
	{
		...
		if (isset($this->_active['filter']) && $this->_active['filter'])
		{
			...
			//search_search : search on Bible Book Name + 
			$search_search = $this->getState('search.search');
			$this->_addSearch('search', 'a.bible_book_name', 'like');
	...
	function _buildQueryOrderBy($order = array(), $pre_order = 'a.ordering, a.bible_book_name')
	{
