 ...
 *
 */
class ZefaniabibleControllerZefaniadictionary extends ZefaniabibleController
{
	var $ctrl = 'zefaniadictionary';
	var $singular = 'zefaniadictionaryitem';
	...
	function new_()
	{
		...
		{
			case 'default':
				JRequest::setVar( 'view'  , 'zefaniadictionaryitem');
				JRequest::setVar( 'layout', 'dictionaryadd' );
				break;
	...
	function edit()
	{
		...
		$model = $this->getModel('zefaniadictionaryitem');
		$item = $model->getItem();
	...
	function delete()
	{
		...
		if (parent::_delete($cid))
		{
			...
			{
				case 'default':
					JRequest::setVar( 'view'  , 'zefaniadictionary');
	...
	function toggle_publish()
	{
		...
		$data = array("publish" => is_null($zefaniadictionaryitem->publish)?1:!$zefaniadictionaryitem->publish);
        $this->_save($data);
