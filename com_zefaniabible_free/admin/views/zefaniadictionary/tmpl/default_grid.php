...
<div class="grid_wrapper">
	...
	<thead>
		<tr>
			...
			<th width="30%">
				<?php echo JHTML::_('grid.sort',  "ZEFANIABIBLE_FIELD_TITLE", 'a.name', $this->state->get('list.direction'), $this->state->get('list.ordering') ); ?>
			</th>

			<th width="35%" style="text-align:center">
				<?php echo JHTML::_('grid.sort',  "ZEFANIABIBLE_FIELD_ALIAS", 'a.alias', $this->state->get('list.direction'), $this->state->get('list.ordering') ); ?>
			</th> 
