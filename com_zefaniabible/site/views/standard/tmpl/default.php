    	...
    	<div class="zef_legend">
        	<?php if(($this->item->flg_reading_rss_button)and($this->item->str_tmpl != "component")){?>
		        <div class="zef_reading_rss">
                	<a title="<?php echo JText::_('ZEFANIABIBLE_RSS_BUTTON_TITLE'); ?>" target="blank" href="<?php echo	JRoute::_('index.php?option=com_zefaniabible&view=biblerss&format=raw&bible='.$this->item->str_Bible_Version.'&book='.$this->item->int_Bible_Book_ID.'&chapter='.$this->item->int_Bible_Chapter);?>" target="_blank" rel="nofollow" >
