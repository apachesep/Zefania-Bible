    	...
    	<div class="zef_legend">
			<?php if($this->item->flg_reading_rss_button){?>
		        <div class="zef_reading_rss">
                	<a title="<?php echo JText::_('ZEFANIABIBLE_RSS_BUTTON_TITLE'); ?>" target="blank" href="index.php?option=com_zefaniabible&view=planrss&format=raw&plan=<?php echo $this->item->str_reading_plan?>&bible=<?php echo $this->item->str_Bible_Version;?>&start=<?php echo $this->pagination->limitstart;?>&items=<?php echo $this->pagination->limit;?>&type=rss" target="_blank" rel="nofollow" >
