...
class ZefaniabibleViewSearch extends JViewLegacy
{
	...
	{		
		...
		$item->query 				= $jinput->get('query', 'john 3:16', 'CMD');
		...
		{
			header('Location: '.substr(JURI::base(),0, -1).JRoute::_('index.php?option=com_zefaniabible&view=search&bible='.$item->str_primary_bible.'&query='.$item->query.'&format=raw', false));	
		}
