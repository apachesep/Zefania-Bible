...
*
*/
class TableZefaniabiblebooksitem extends JTable
{
	...
	*/
	...
	{
		parent::__construct('#__zefaniabible_zefaniabiblebooknames', 'id', $db);
	}
	...
	*/
	...
	function check()
	{
		...
		$this->bible_book_name = $filter->clean($this->bible_book_name, 'STRING');
