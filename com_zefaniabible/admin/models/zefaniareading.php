...
/**
 * Zefaniabible Component Zefaniareading Model
 *
 * @package		Joomla
 * @subpackage	Zefaniabible
 *
 */
class ZefaniabibleModelZefaniareading extends ZefaniabibleModelList
{
	var $_name_sing = 'zefaniareadingitem';
	...
	function _buildQueryWhere($where = array())
	{
		...
		if (isset($this->_active['filter']) && $this->_active['filter'])
		{
			...
			//search_search : search on  + Description
