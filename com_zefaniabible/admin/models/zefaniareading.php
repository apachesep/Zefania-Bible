...
/**
 * List Model for zefaniareading.
 *
 * @package     Zefaniabible
 * @subpackage  Models
 */
class ZefaniabibleModelZefaniareading extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->select('a.*')->from('#__zefaniabible_zefaniareading AS a');				
	...
	public function getAuthors()
	{
		...
		$query->select('u.id AS value, u.name AS text')
			->from('#__users AS u')
			->join('INNER', '#__zefaniabible_zefaniareading AS a ON a.created_by = u.id')
			->group('u.id, u.name')
			->order('u.name');
