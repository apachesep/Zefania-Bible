...
/**
 * Zefaniabible Component Zefaniabiblebooksitem Model
 *
 * @package		Joomla
 * @subpackage	Zefaniabible
 *
 */
class ZefaniabibleModelZefaniabiblebooksitem extends ZefaniabibleModelItem
{
	var $_name_plur = 'zefaniabiblebooknames';
	var $params;
	...
	/**
	 * Method to initialise the zefaniabiblebooksitem data
	 *
	 * @access	private
	...
	/**
	 * Method to build a the query string for the Zefaniabiblebooksitem
	 *
	 * @access public
	 * @return integer
	 */
	function _buildQuery()
	{
		...
		{
			case 'addbiblebook': return $this->_buildQuery_addbiblebook(); break;
			...
			$query = 'SELECT a.*'
					...
					.	' FROM `#__zefaniabible_zefaniabiblebooknames` AS a'
	...
	function _buildQuery_addbiblebook()
	{
	...
	/**
	 * Method to update zefaniabiblebooksitem in mass
	 *
	 * @access	public
	 * @return	boolean	True on success
	 */
	...
	/**
	 * Method to save the zefaniabiblebooksitem
	 *
	 * @access	public
	 * @return	boolean	True on success
	 */
	...
	/**
	 * Method to delete a zefaniabiblebooksitem
	 *
	 * @access	public
	 * @return	boolean	True on success
	 */
	function delete($cid = array())
	{
		...
		if (count( $cid ))
		{
			...
			$query = 'DELETE FROM `#__zefaniabible_zefaniabiblebooknames`'
				. ' WHERE id IN ( '.$cids.' )';
	...
	/**
	 * Method to (un)publish a zefaniabiblebooksitem
	 *
	 * @access	public
	 * @return	boolean	True on success
	 */
	function publish($cid = array(), $publish = 1)
	{
		...
		if (count( $cid ))
		{
			...
			$query = 'UPDATE #__zefaniabible_zefaniabiblebooknames'
	...
	/**
	 * Method to move a zefaniabiblebooksitem
	 *
	 * @access	public
	 * @return	boolean	True on success
	 */
	...
	/**
	 * Method to save the order of the zefaniabiblebooknames
	 *
	 * @access	public
	 * @return	boolean	True on success
	 */
