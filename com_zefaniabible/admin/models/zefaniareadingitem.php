...
/**
 * Zefaniabible Component Zefaniareadingitem Model
 *
 * @package		Joomla
 * @subpackage	Zefaniabible
 *
 */
class ZefaniabibleModelZefaniareadingitem extends ZefaniabibleModelItem
{
	var $_name_plur = 'zefaniareading';
	var $params;
	...
	/**
	 * Method to initialise the zefaniareadingitem data
	 *
	 * @access	private
	...
	/**
	 * Method to build a the query string for the Zefaniareadingitem
	 *
	 * @access public
	 * @return integer
	 */
	function _buildQuery()
	{
		...
		{
			case 'addreading': return $this->_buildQuery_addreading(); break;
			...
			$query = 'SELECT a.*'
					...
					.	' FROM `#__zefaniabible_zefaniareading` AS a'
	...
	function _buildQuery_addreading()
	{
	...
	/**
	 * Method to update zefaniareadingitem in mass
	 *
	 * @access	public
	 * @return	boolean	True on success
	 */
	...
	/**
	 * Method to save the zefaniareadingitem
	 *
	 * @access	public
	 * @return	boolean	True on success
	 */
	...
	/**
	 * Method to delete a zefaniareadingitem
	 *
	 * @access	public
	 * @return	boolean	True on success
	 */
	function delete($cid = array())
	{
		...
		if (count( $cid ))
		{
			...
			$query = 'DELETE FROM `#__zefaniabible_zefaniareading`'
				. ' WHERE id IN ( '.$cids.' )';
	...
	/**
	 * Method to move a zefaniareadingitem
	 *
	 * @access	public
	 * @return	boolean	True on success
	 */
	...
	/**
	 * Method to save the order of the zefaniareading
	 *
	 * @access	public
	 * @return	boolean	True on success
	 */
	...
	/**
	 * Method to (un)publish a zefaniareadingitem
	 *
	 * @access	public
	 * @return	boolean	True on success
	 */
	function publish($cid = array(), $publish = 1)
	{
		...
		if (count( $cid ))
		{
			...
			$query = 'UPDATE #__zefaniabible_zefaniareading'
