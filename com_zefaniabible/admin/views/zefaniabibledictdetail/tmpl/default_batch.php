...
<div class="modal hide fade" id="collapseModal">
	<div class="modal-header">
		...
		<h3><?php echo JText::_('COM_ZEFANIABIBLE_BATCH_OPTIONS');?></h3>
	</div>
	<div class="modal-body">
		<p><?php echo JText::_('COM_ZEFANIABIBLE_BATCH_TIP'); ?></p>
	</div>
	<div class="modal-footer">
		...
		<button class="btn btn-primary" type="submit" onclick="Joomla.submitbutton('zefaniabibledictdetailitem.batch');">
