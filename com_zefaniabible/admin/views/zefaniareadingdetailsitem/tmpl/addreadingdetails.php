...
<?php	JToolBarHelper::title(JText::_("ZEFANIABIBLE_LAYOUT_ADD_READING_DETAILS"), 'zefaniabible_zefaniareadingdetails' );?>
...
<form action="<?php echo(JRoute::_("index.php")); ?>" method="post" name="adminForm" id="adminForm" class='form-validate'>
	...
	<?php echo JDom::_('html.form.footer', array(
		...
		'values' => array(
				...
				'view' => "zefaniareadingdetailsitem",
				'layout' => "addreadingdetails"
				)));
	?>
