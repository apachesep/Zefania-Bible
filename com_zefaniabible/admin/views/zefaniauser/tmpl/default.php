		...
		?>
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td class="left" style="text-align:center">
	                <?php echo JHtml::_('jgrid.published', $item->send_reading_plan_email, $i, 'zefaniauser.reading_', true); ?>
				</td>
				<td class="left" style="text-align:center">
	                <?php echo JHtml::_('jgrid.published', $item->send_verse_of_day_email, $i, 'zefaniauser.verse_', true); ?>
                </td>
