...
<?php	JToolBarHelper::title(JText::_("ZEFANIABIBLE_LAYOUT_ADD_BIBLE_BOOK"), 'zefaniabible_zefaniabiblebooknames' );?>
...
<form action="<?php echo(JRoute::_("index.php")); ?>" method="post" name="adminForm" id="adminForm" class='form-validate'>
	...
	<?php echo JDom::_('html.form.footer', array(
		'dataObject' => $this->zefaniabiblebooksitem,
		'values' => array(
				'option' => "com_zefaniabible",
				'view' => "zefaniabiblebooksitem",
				'layout' => "addbiblebook"
				)));
	?>
