...
class ZefaniabibleViewZefaniabible extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			{
			    JToolBarHelper::divider();
			    JToolBarHelper::archiveList('zefaniabible.archive','JTOOLBAR_ARCHIVE');
            }
        ...
        if (isset($this->items[0]->published))
		{
			...
			{
			    JToolBarHelper::deleteList('', 'zefaniabible.delete','JTOOLBAR_EMPTY_TRASH');
			    JToolBarHelper::divider();
		    }
			else if ($state->get('filter.published') != -2 && $canDo->get('core.edit.state'))
			{
			    JToolBarHelper::trash('zefaniabible.trash','JTOOLBAR_TRASH');
			    JToolBarHelper::divider();
		    }
        }
