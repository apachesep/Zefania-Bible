...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_zefaniabible&task=zefaniadictionary.saveOrderAjax&tmpl=component';
		...
		<thead>
			<tr>
				...
				<th class="nowrap left">
					<?php echo JHtml::_('searchtools.sort', JText::_('ZEFANIABIBLE_FIELD_NAME'), 'a.name', $listDirn, $listOrder) ?>
				</th>
				<th class="nowrap left">
					<?php echo JText::_('ZEFANIABIBLE_FIELD_STATUS'); ?>
				</th>                
				<th class="nowrap left">
					<?php echo JHtml::_('searchtools.sort', JText::_('ZEFANIABIBLE_FIELD_XML_DICTIONARY_FILE_LOCATION'), 'a.xml_file_url', $listDirn, $listOrder) ?>
				</th>
