 ...
 *
 */
class ZefaniabibleControllerCpanel extends ZefaniabibleController
{
	var $ctrl = 'cpanel';
	var $singular = 'cpanelitem';
	...
	function new_()
	{
		...
		{
			case 'default':
				JRequest::setVar( 'view'  , 'cpanelitem');
	...
	function edit()
	{
		...
		$model = $this->getModel('cpanelitem');
		$item = $model->getItem();
	...
	function toggle_publish()
	{
		...
		$data = array("publish" => is_null($cpanelitem->publish)?1:!$cpanelitem->publish);
        $this->_save($data);
