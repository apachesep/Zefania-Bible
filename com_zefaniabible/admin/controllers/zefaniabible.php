 ...
 *
 */
class ZefaniabibleControllerZefaniabible extends ZefaniabibleController
{
	var $ctrl = 'zefaniabible';
	var $singular = 'zefaniabibleitem';
	...
	function new_()
	{
		...
		{
			case 'default':
				JRequest::setVar( 'view'  , 'zefaniabibleitem');
	...
	function toggle_publish()
	{
		...
		$data = array("publish" => is_null($zefaniabibleitem->publish)?1:!$zefaniabibleitem->publish);
        $this->_save($data);
