...
/**
 * Zefaniabible Zefaniabiblebooknames Controller
 *
 * @package		Joomla
 * @subpackage	Zefaniabible
 *
 */
class ZefaniabibleControllerZefaniabiblebooknames extends ZefaniabibleController
{
	var $ctrl = 'zefaniabiblebooknames';
	var $singular = 'zefaniabiblebooksitem';
	...
	function new_()
	{
		...
		//Bible Book Name
		$filter_bible_book_name = $app->getUserState( $this->context . ".filter.bible_book_name");
		if ($filter_bible_book_name) $vars["filter_bible_book_name"] = $filter_bible_book_name;
		...
		{
			case 'default':
				JRequest::setVar( 'view'  , 'zefaniabiblebooksitem');
				JRequest::setVar( 'layout', 'addbiblebook' );
				break;
	...
	function edit()
	{
		...
		$model = $this->getModel('zefaniabiblebooksitem');
		$item = $model->getItem();
	...
	function delete()
	{
		...
		if (parent::_delete($cid))
		{
			...
			{
				case 'default':
					JRequest::setVar( 'view'  , 'zefaniabiblebooknames');
