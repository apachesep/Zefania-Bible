...
{
	var $ctrl = 'zefaniacomment';
	var $singular = 'zefaniacommentitems';
	...
	function new_()
	{
		...
		{
			case 'default':
				JRequest::setVar( 'view'  , 'zefaniacommentitems');
				JRequest::setVar( 'layout', 'commentaryadd' );
				break;
	...
	function edit()
	{
		...
		$model = $this->getModel('zefaniacommentitems');
		$item = $model->getItem();
	...
	function delete()
	{
		...
		if (parent::_delete($cid))
		{
			...
			{
				case 'default':
					JRequest::setVar( 'view'  , 'zefaniacomment');
	...
	function toggle_publish()
	{
		...
		$data = array("publish" => is_null($zefaniacommentitems->publish)?1:!$zefaniacommentitems->publish);
        $this->_save($data);
