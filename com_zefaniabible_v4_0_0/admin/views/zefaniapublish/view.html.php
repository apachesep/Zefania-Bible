...
/**
 * Zefaniapublish list view class.
 *
 * @package     Zefaniabible
 * @subpackage  Views
 */
class ZefaniabibleViewZefaniapublish extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		ZefaniabibleHelper::addSubmenu('zefaniapublish');
	...
	protected function addToolbar()
	{
		...
		{
			JToolBarHelper::addNew('zefaniapublishitem.add','JTOOLBAR_NEW');
		}

		if (($canDo->get('core.edit')) && isset($this->items[0]))
		{
			JToolBarHelper::editList('zefaniapublishitem.edit','JTOOLBAR_EDIT');
		}
		
		if ($canDo->get('core.delete') && isset($this->items[0]))
		{
            JToolBarHelper::deleteList('', 'zefaniapublish.delete','JTOOLBAR_DELETE');
		}
