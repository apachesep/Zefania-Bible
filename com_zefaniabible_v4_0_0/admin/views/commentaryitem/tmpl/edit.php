...
<form action="<?php JRoute::_('index.php?option=com_zefaniabible&id=' . (int)$this->item->id); ?>" method="post" name="adminForm" id="commentaryitem-form" class="form-validate">
	...
	<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'details')); ?>
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'details', 'CommentaryItem', $this->item->id, true); ?>
		<div class="row-fluid">
			<div class="span9">
