...
<form action="<?php echo JRoute::_('index.php?option=com_zefaniabible&view=commentary'); ?>" method="post" name="adminForm" id="adminForm">
				...
				<td class="nowrap has-context">
						<div class="pull-left">
							<?php if ($canEdit || $canEditOwn) : ?>
								<a href="<?php echo JRoute::_('index.php?option=com_zefaniabible&task=commentaryitem.edit&id='.(int) $item->id); ?>">
						...
						<div class="pull-left">
							<?php
								...
								JHtml::_('dropdown.edit', $item->id, 'commentaryitem.');
								if (!isset($this->items[0]->published) || $this->state->get('filter.published') == -2) :
									JHtml::_('dropdown.addCustomItem', JText::_('JTOOLBAR_DELETE'), 'javascript:void(0)', "onclick=\"contextAction('cb$i', 'commentary.delete')\"");
								endif;
