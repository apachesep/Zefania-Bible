...
class ZefaniabibleViewCommentary extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		ZefaniabibleHelper::addSubmenu('commentary');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_ZEFANIABIBLE_ZEFANIABIBLE_COMMENT_TEXT_VIEW_COMMENTARY_TITLE'));
		
		if ($canDo->get('core.create'))
		{
			JToolBarHelper::addNew('commentaryitem.add','JTOOLBAR_NEW');
		}

		if (($canDo->get('core.edit')) && isset($this->items[0]))
		{
			JToolBarHelper::editList('commentaryitem.edit','JTOOLBAR_EDIT');
		}
		
		if ($canDo->get('core.delete') && isset($this->items[0]))
		{
            JToolBarHelper::deleteList('', 'commentary.delete','JTOOLBAR_DELETE');
		}
