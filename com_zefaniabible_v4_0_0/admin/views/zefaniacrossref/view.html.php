...
/**
 * Zefaniacrossref list view class.
 *
 * @package     Zefaniabible
 * @subpackage  Views
 */
class ZefaniabibleViewZefaniacrossref extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		ZefaniabibleHelper::addSubmenu('zefaniacrossref');
	...
	protected function addToolbar()
	{
		...
		{
			JToolBarHelper::addNew('zefaniacrossrefitem.add','JTOOLBAR_NEW');
		}

		if (($canDo->get('core.edit')) && isset($this->items[0]))
		{
			JToolBarHelper::editList('zefaniacrossrefitem.edit','JTOOLBAR_EDIT');
		}
		
		if ($canDo->get('core.delete') && isset($this->items[0]))
		{
            JToolBarHelper::deleteList('', 'zefaniacrossref.delete','JTOOLBAR_DELETE');
		}
