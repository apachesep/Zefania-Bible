...
/**
 * Item Model for zefaniaverseofdayitem.
 *
 * @package     Zefaniabible
 * @subpackage  Models
 */
class ZefaniabibleModelZefaniaverseofdayitem extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_zefaniabible.zefaniaverseofdayitem';
