...
* @subpackage	Classes
*/
class ZefaniabibleCkModelThirduser extends ZefaniabibleClassModelItem
{
	/**
	* View list alias
	*
	...
	* @since	1.6
	*/
	public function getTable($type = 'thirduser', $prefix = 'ZefaniabibleTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_zefaniabible.edit.user.data', array());
...
if (!class_exists('ZefaniabibleModelThirduser')){ class ZefaniabibleModelThirduser extends ZefaniabibleCkModelThirduser{} }
