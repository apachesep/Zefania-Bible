...
* @subpackage	Classes
*/
class ZefaniabibleCkModelThirdviewlevels extends ZefaniabibleClassModelList
{
	/**
...
if (!class_exists('ZefaniabibleModelThirdviewlevels')){ class ZefaniabibleModelThirdviewlevels extends ZefaniabibleCkModelThirdviewlevels{} }
