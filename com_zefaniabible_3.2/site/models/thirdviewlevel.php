...
* @subpackage	Classes
*/
class ZefaniabibleCkModelThirdviewlevel extends ZefaniabibleClassModelItem
{
	/**
	* View list alias
	*
	...
	* @since	1.6
	*/
	public function getTable($type = 'thirdviewlevel', $prefix = 'ZefaniabibleTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_zefaniabible.edit.viewlevel.data', array());
...
if (!class_exists('ZefaniabibleModelThirdviewlevel')){ class ZefaniabibleModelThirdviewlevel extends ZefaniabibleCkModelThirdviewlevel{} }
