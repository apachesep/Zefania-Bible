...
<div class="">
	<table class='table' id='grid-biblenames'>
		<thead>
			<tr>
				...
				<th>
					<?php echo JHTML::_('grid.sort',  "ZEFANIABIBLE_FIELD_BIBLE_NAME", 'a.bible_name', $listDirn, $listOrder ); ?>
				</th>
