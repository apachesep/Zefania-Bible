...
JDom::_('framework.sortablelist', array(
	'domId' => 'grid-zefaniabibledictionaryinfo',
	'listOrder' => $listOrder,
	'listDirn' => $listDirn,
	'formId' => 'adminForm',
	'ctrl' => 'zefaniabibledictionaryinfo',
	'proceedSaveOrderButton' => true,
));
?>
<div class="clearfix"></div>
<div class="">
	<table class='table' id='grid-zefaniabibledictionaryinfo'>
		<thead>
			<tr>
				...
				<th>
					<?php echo JHTML::_('grid.sort',  "ZEFANIABIBLE_FIELD_DICTIONARY_NAME", 'a.name', $listDirn, $listOrder ); ?>
				</th>
				...
				<?php if ($model->canEditState()): ?>
				<th>
					<?php echo JHTML::_('grid.sort',  "ZEFANIABIBLE_FIELD_PUBLISH", 'a.published', $listDirn, $listOrder ); ?>
				</th>
				<?php endif; ?>
			</tr>
		</thead>
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td>
					<?php echo JDom::_('html.fly', array(
						...
						'dataObject' => $row,
						'num' => $i,
						'task' => 'zefaniabibledictionaryinfoitem.edit'
					));?>
				</td>
