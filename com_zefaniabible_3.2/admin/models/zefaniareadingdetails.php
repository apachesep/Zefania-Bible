...
* @subpackage	Classes
*/
class ZefaniabibleCkModelZefaniareadingdetails extends ZefaniabibleClassModelList
{
	/**
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		{
			case 'zefaniareadingdetails.default':

				//BASE FIELDS
				$this->addSelect(	'a.begin_chapter,'
								.	'a.begin_verse,'
								.	'a.day_number,'
								.	'a.description,'
								.	'a.end_chapter,'
				...
				$this->addGroupOrder('a.plan');

				break;

			case 'zefaniareadingdetails.modal':

				//BASE FIELDS
				$this->addSelect(	'a.plan');
		...
		$this->addSearch('search', 'a.begin_chapter', 'like');
		$this->addSearch('search', 'a.day_number', 'like');
		$this->addSearch('search', 'a.end_chapter', 'like');
		$this->addSearch('search', 'a.plan', 'like');
		$this->addSearch('search', 'a.description', 'like');
		$this->addSearch('search', '_plan_.name', 'like');
		$this->addSearch('search', '_plan_.alias', 'like');
		...
		$this->addSearch('search_1', 'a.begin_chapter', 'like');
		$this->addSearch('search_1', 'a.day_number', 'like');
		$this->addSearch('search_1', 'a.end_chapter', 'like');
		$this->addSearch('search_1', 'a.plan', 'like');
		$this->addSearch('search_1', 'a.description', 'like');
		$this->addSearch('search_1', '_plan_.name', 'like');
		$this->addSearch('search_1', '_plan_.alias', 'like');
...
if (!class_exists('ZefaniabibleModelZefaniareadingdetails')){ class ZefaniabibleModelZefaniareadingdetails extends ZefaniabibleCkModelZefaniareadingdetails{} }
