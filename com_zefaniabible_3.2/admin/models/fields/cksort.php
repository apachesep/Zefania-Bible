...
* @subpackage	Form
*/
class ZefaniabibleCkFormFieldCksort extends ZefaniabibleClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCksort')){ class JFormFieldCksort extends ZefaniabibleCkFormFieldCksort{} }
