...
* @subpackage	Form
*/
class ZefaniabibleCkFormFieldCktext extends ZefaniabibleClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCktext')){ class JFormFieldCktext extends ZefaniabibleCkFormFieldCktext{} }
