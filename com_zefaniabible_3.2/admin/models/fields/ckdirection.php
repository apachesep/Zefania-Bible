...
* @subpackage	Form
*/
class ZefaniabibleCkFormFieldCkdirection extends ZefaniabibleClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkdirection')){ class JFormFieldCkdirection extends ZefaniabibleCkFormFieldCkdirection{} }
