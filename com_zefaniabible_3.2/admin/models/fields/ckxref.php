...
* @subpackage	Form
*/
class ZefaniabibleCkFormFieldCkxref extends ZefaniabibleClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkxref')){ class JFormFieldCkxref extends ZefaniabibleCkFormFieldCkxref{} }
