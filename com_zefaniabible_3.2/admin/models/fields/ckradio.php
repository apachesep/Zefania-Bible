...
* @subpackage	Form
*/
class ZefaniabibleCkFormFieldCkradio extends ZefaniabibleClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkradio')){ class JFormFieldCkradio extends ZefaniabibleCkFormFieldCkradio{} }
