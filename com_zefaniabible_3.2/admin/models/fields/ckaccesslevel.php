...
* @subpackage	Form
*/
class ZefaniabibleCkFormFieldCkaccesslevel extends ZefaniabibleClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkaccesslevel')){ class JFormFieldCkaccesslevel extends ZefaniabibleCkFormFieldCkaccesslevel{} }
