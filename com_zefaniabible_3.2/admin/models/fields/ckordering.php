...
* @subpackage	Form
*/
class ZefaniabibleCkFormFieldCkordering extends ZefaniabibleClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkordering')){ class JFormFieldCkordering extends ZefaniabibleCkFormFieldCkordering{} }
