...
* @subpackage	Form
*/
class ZefaniabibleCkFormFieldCkajax extends ZefaniabibleClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkajax')){ class JFormFieldCkajax extends ZefaniabibleCkFormFieldCkajax{} }
