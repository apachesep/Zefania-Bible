...
* @subpackage	Form
*/
class ZefaniabibleCkFormFieldCkstate extends ZefaniabibleClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkstate')){ class JFormFieldCkstate extends ZefaniabibleCkFormFieldCkstate{} }
