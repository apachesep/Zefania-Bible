...
* @subpackage	Form
*/
class ZefaniabibleCkFormFieldCkcombo extends ZefaniabibleClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkcombo')){ class JFormFieldCkcombo extends ZefaniabibleCkFormFieldCkcombo{} }
