...
* @subpackage	Form
*/
class ZefaniabibleCkFormFieldCkcalendar extends ZefaniabibleClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkcalendar')){ class JFormFieldCkcalendar extends ZefaniabibleCkFormFieldCkcalendar{} }
