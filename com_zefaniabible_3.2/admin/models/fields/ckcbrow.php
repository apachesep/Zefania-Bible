...
* @subpackage	Form
*/
class ZefaniabibleCkFormFieldCkcbrow extends ZefaniabibleClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkcbrow')){ class JFormFieldCkcbrow extends ZefaniabibleCkFormFieldCkcbrow{} }
