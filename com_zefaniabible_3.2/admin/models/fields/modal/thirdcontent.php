...
* @subpackage	Form
*/
class ZefaniabibleCkJFormFieldModal_Thirdcontent extends ZefaniabibleClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'ZEFANIABIBLE_DATA_PICKER_SELECT_CONTENT';
...
if (!class_exists('JFormFieldModal_Thirdcontent')){ class JFormFieldModal_Thirdcontent extends ZefaniabibleCkJFormFieldModal_Thirdcontent{} }
