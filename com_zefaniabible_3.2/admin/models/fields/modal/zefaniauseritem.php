...
* @subpackage	Form
*/
class ZefaniabibleCkJFormFieldModal_Zefaniauseritem extends ZefaniabibleClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'ZEFANIABIBLE_DATA_PICKER_SELECT_ZEFANIAUSER_ITEM';
	...
	* @var string
	*/
	protected $type = 'modal_zefaniauseritem';
	...
	*/
	protected function getInput()
	{
		...
		$db->setQuery(
			'SELECT `user_name`' .
			' FROM #__zefaniabible_zefaniauser' .
...
if (!class_exists('JFormFieldModal_Zefaniauseritem')){ class JFormFieldModal_Zefaniauseritem extends ZefaniabibleCkJFormFieldModal_Zefaniauseritem{} }
