...
* @subpackage	Form
*/
class ZefaniabibleCkJFormFieldModal_Thirdviewlevel extends ZefaniabibleClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'ZEFANIABIBLE_DATA_PICKER_SELECT_VIEWLEVEL';
...
if (!class_exists('JFormFieldModal_Thirdviewlevel')){ class JFormFieldModal_Thirdviewlevel extends ZefaniabibleCkJFormFieldModal_Thirdviewlevel{} }
