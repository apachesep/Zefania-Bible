...
* @subpackage	Form
*/
class ZefaniabibleCkJFormFieldModal_Zefaniabibleitem extends ZefaniabibleClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'ZEFANIABIBLE_DATA_PICKER_SELECT_ZEFANIABIBLE_ITEM';
	...
	* @var string
	*/
	protected $type = 'modal_zefaniabibleitem';
	...
	*/
	protected function getInput()
	{
		...
		$db->setQuery(
			'SELECT `bible_name`' .
			' FROM #__zefaniabible_biblenames' .
...
if (!class_exists('JFormFieldModal_Zefaniabibleitem')){ class JFormFieldModal_Zefaniabibleitem extends ZefaniabibleCkJFormFieldModal_Zefaniabibleitem{} }
