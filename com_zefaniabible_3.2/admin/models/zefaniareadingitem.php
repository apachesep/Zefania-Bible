...
* @subpackage	Classes
*/
class ZefaniabibleCkModelZefaniareadingitem extends ZefaniabibleClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'addreading', 'STRING');
	}
	...
	* @since	1.6
	*/
	public function getTable($type = 'zefaniareadingitem', $prefix = 'ZefaniabibleTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_zefaniabible.edit.zefaniareadingitem.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('zefaniareadingitem.id') == 0)
			{
				$jinput = JFactory::getApplication()->input;
	...
	* @param	integer	$pk	The primary id key of the zefaniareadingitem
	* @return	void
	*/
	protected function prepareQuery(&$query, $pk)
	{
		...
		{
			case 'zefaniareadingitem.addreading':
...
if (!class_exists('ZefaniabibleModelZefaniareadingitem')){ class ZefaniabibleModelZefaniareadingitem extends ZefaniabibleCkModelZefaniareadingitem{} }
