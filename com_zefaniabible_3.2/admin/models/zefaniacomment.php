...
* @subpackage	Classes
*/
class ZefaniabibleCkModelZefaniacomment extends ZefaniabibleClassModelList
{
	/**
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		$this->addSearch('search', 'a.full_name', 'like');
		...
		$this->addSearch('search_1', 'a.full_name', 'like');
...
if (!class_exists('ZefaniabibleModelZefaniacomment')){ class ZefaniabibleModelZefaniacomment extends ZefaniabibleCkModelZefaniacomment{} }
