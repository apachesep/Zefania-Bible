...
* @subpackage	Form
*/
class ZefaniabibleCkFormRuleDefault extends ZefaniabibleClassFormRule
{
	/**
...
if (!class_exists('JFormRuleDefault')){ class JFormRuleDefault extends ZefaniabibleCkFormRuleDefault{} }
