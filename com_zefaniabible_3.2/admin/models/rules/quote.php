...
* @subpackage	Form
*/
class ZefaniabibleCkFormRuleQuote extends ZefaniabibleClassFormRule
{
	/**
...
if (!class_exists('JFormRuleQuote')){ class JFormRuleQuote extends ZefaniabibleCkFormRuleQuote{} }
