...
* @subpackage	Form
*/
class ZefaniabibleCkFormRuleRegexp extends ZefaniabibleClassFormRule
{
	/**
...
if (!class_exists('JFormRuleRegexp')){ class JFormRuleRegexp extends ZefaniabibleCkFormRuleRegexp{} }
