...
* @subpackage	Form
*/
class ZefaniabibleCkFormRuleNumeric extends ZefaniabibleClassFormRule
{
	/**
...
if (!class_exists('JFormRuleNumeric')){ class JFormRuleNumeric extends ZefaniabibleCkFormRuleNumeric{} }
