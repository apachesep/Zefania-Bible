...
* @subpackage	Classes
*/
class ZefaniabibleCkModelBiblenames extends ZefaniabibleClassModelList
{
	/**
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		switch($this->getState('context', 'all'))
		{
			...
			case 'biblenames.scripture':

				//BASE FIELDS
				$this->addSelect(	'a.bible_name');


				break;

			case 'biblenames.modal':
		...
		$this->addSearch('search', 'a.bible_name', 'like');
		...
		$this->addSearch('search_1', 'a.bible_name', 'like');
...
if (!class_exists('ZefaniabibleModelBiblenames')){ class ZefaniabibleModelBiblenames extends ZefaniabibleCkModelBiblenames{} }
