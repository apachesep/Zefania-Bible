...
class plgSearchZefaniaBible extends JPlugin
{
	...
	function onContentSearch($text, $phrase='', $ordering='', $areas=null)
	{
		...
		JFactory::getLanguage()->load('com_zefaniabible', JPATH_BASE, 'en-GB', true);
		$jlang->load('plg_search_zefaniabible', JPATH_ADMINISTRATOR, 'en-GB', true);		
		for($i = 1; $i <=66; $i++)
		{
		...
		$jlang->load('plg_search_zefaniabible', JPATH_ADMINISTRATOR, null, true); 
